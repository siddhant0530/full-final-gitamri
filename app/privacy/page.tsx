...
export default function PrivacyPage() {
  return (
    <PolicyLayout title="Privacy Policy" updated="24 July 2026">
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">1. Introduction</h2>
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">2. Information We Collect</h2>
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">3. How We Use Your Information</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">4. Sharing With Our Service Providers</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">5. Data Retention</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">6. Your Rights</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">7. Contact Us</h2>
        <p className="mt-3 leading-7 text-zinc-700">
