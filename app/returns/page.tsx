...
export default function ReturnsPage() {
  return (
    <PolicyLayout title="Return & Refund Policy" updated="24 July 2026">
      <div>
        <h2 className="text-xl font-bold text-[#123524]">1. Our Promise</h2>
      ...
      <div>
        <h2 className="text-xl font-bold text-[#123524]">2. Reporting Window</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#123524]">3. How to Report an Issue</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#123524]">4. Resolution</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#123524]">5. Refund Timelines</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#123524]">6. Non-Returnable Situations</h2>
