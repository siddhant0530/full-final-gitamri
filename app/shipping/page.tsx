...
export default function ShippingPage() {
  return (
    <PolicyLayout title="Shipping Policy" updated="24 July 2026">
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">1. Delivery Partner</h2>
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">2. Processing Time</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">3. Delivery Timelines</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">4. Shipping Charges</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">5. Order Tracking</h2>
        <p className="mt-3 leading-7 text-zinc-700">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#183F35]">6. Delivery Issues</h2>
        <p className="mt-3 leading-7 text-zinc-700">
