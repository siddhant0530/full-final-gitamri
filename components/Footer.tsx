    ...
    <footer className="bg-olive">
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center">
          <p className="uppercase tracking-[5px] text-gold-400 font-semibold">Available On</p>
          <h2 className="text-4xl font-bold text-ivory mt-3">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-12 max-w-2xl mx-auto">
          {stores.map((s) => (
            <a key={s.name} href={s.href} target="_blank" rel="noopener noreferrer"
              className="rounded-3xl border border-gold-300 bg-white/95 p-8 shadow-lg hover:-translate-y-2 transition">
              <Image
                src={s.logo}
                alt={s.name}
        ...
        <div className="text-center mt-20">
          <h2 className="text-5xl font-black text-ivory leading-tight">
      ...
      <div className="bg-[#16211A] text-white">
        <div className="max-w-7xl mx-auto grid gap-8 px-6 py-14 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
          ...
          <div>
            <h4 className="font-semibold text-gold-400 mb-4">Categories</h4>
            <ul className="space-y-2 text-gray-300">
              {categories.slice(0, 5).map((cat) => (
                <li key={cat.slug}>
                  <Link href={`/category/${cat.slug}`} className="hover:text-gold-300">
                    {cat.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="font-semibold text-gold-400 mb-4">Policies</h4>
            <ul className="space-y-2 text-gray-300">
              <li><Link href="/privacy" className="hover:text-gold-300">Privacy Policy</Link></li>
              <li><Link href="/shipping" className="hover:text-gold-300">Shipping Policy</Link></li>
              <li><Link href="/returns" className="hover:text-gold-300">Returns Policy</Link></li>
              <li><Link href="/terms" className="hover:text-gold-300">Terms of Service</Link></li>
            </ul>
          </div>
              ...
              <p className="flex items-start gap-2 min-w-0">
                ...
                <span className="min-w-0">
                  ...
                  <a
                    ...
                    className="break-all hover:text-gold-300 transition"
                  >
              ...
              <p className="flex items-start gap-2 min-w-0">
                ...
                <span className="min-w-0">
                  ...
                  <a
                    ...
                    className="break-words hover:text-gold-300 transition"
                  >
          ...
          {/* Follow Us */}
          <div>
            <h4 className="font-semibold text-gold-400 mb-4">Follow Us</h4>
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="flex items-center justify-center text-white/80 transition hover:text-gold-300"
              >
                <Instagram size={22} />
              </a>
